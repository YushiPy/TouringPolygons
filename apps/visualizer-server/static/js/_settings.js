...
export const POLYGON_INSIDE_ALPHA = 1.0;

//export const SOLUTION_COLOR = "#DC9D2F";
export const SOLUTION_COLOR = "#DC9D2F00";

// export const BACKGROUND_COLOR = "#121212";
export const BACKGROUND_COLOR = "#ffffff";
//export const POINT_RADIUS = 8;
export const POINT_RADIUS = 0;

//export const MAIN_AXIS_COLOR = "#E0E0E0";
//export const GRID_COLOR = "#555555";
//export const SUB_GRID_COLOR = "#2A2A2A";

export const MAIN_AXIS_COLOR = "#E0E0E000";
export const GRID_COLOR = "#55555500";
export const SUB_GRID_COLOR = "#2A2A2A00";

//export const GRID_NUMBER_COLOR = "#E0E0E0";
//export const GRID_NUMBER_LIGHT_COLOR = "#777777";

export const GRID_NUMBER_COLOR = "#E0E0E000";
export const GRID_NUMBER_LIGHT_COLOR = "#77777700";
