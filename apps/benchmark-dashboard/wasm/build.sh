...
em++ \
	...
	-sEXPORTED_FUNCTIONS='["_malloc","_free","_tpp_solve","_tpp_solve_piece_groups","_tpp_solve_convex","_tpp_solve_convex_maps","_tpp_get_path_points","_tpp_get_map_rays","_tpp_get_map_offsets","_tpp_get_map_first_contact","_tpp_solution_exact","_tpp_solution_calls","_tpp_solution_seconds"]' \
	-sEXPORTED_RUNTIME_METHODS='["HEAPF64","HEAP32","HEAPU8"]' \
