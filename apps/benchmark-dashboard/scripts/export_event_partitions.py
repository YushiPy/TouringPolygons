...
def main() -> None:
	...
	with output.open("x") as file:
		json.dump({"algorithm": "optimal_convex_partition::decompose_polygon", "source_sha256": hashlib.sha256(DATA_PATH.read_bytes()).hexdigest(), "cases": parts}, file, separators=(",", ":"))
