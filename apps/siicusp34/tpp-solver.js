/*
 * Frozen event-local copy of the fixed-order convex TPP solver.
 *
 * This file intentionally has no dependency on an application outside
 * apps/siicusp34. The public event is a static artifact and must remain
 * deployable by copying this directory alone. The historical visualizer
 * supplied the reference implementation; future changes to the research
 * solver must not silently change this archived event.
 */

import { Vector2 } from "./tpp-vector2.js";
