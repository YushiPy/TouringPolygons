...
def build(args: argparse.Namespace) -> dict[str, object]:
	...
	comparison.update({
		"time": {
			...
			"common_ours_mean_seconds": time["ours_common_completed"]["mean"],
			"common_fekete_mean_seconds": time["fekete_completed_only"]["mean"],
			"common_ours_total_hours": time["ours_common_completed"]["mean"] * time["ours_common_completed"]["n"] / 3600,
			"common_fekete_total_hours": time["total_cpu_hours"]["fekete_completed_only"],
		},
