...
function initializePieceChallenge(combined = false) {
	...
	function render() {
		...
		const impact = combined ? '<aside class="challenge-impact"><strong>Achou difícil?</strong> No caso 49, combinar as 60! ordens com uma escolha de peça convexa por região dá cerca de 1,6 × 10<sup>117</sup> combinações formais. Nosso solver concluiu esse caso em 2,47 s, numa execução com uma thread. Essa contagem bruta não é o número de ramos examinados: limites geométricos e podas reduzem a busca.</aside>' : "";
