...
\Function {RegiãoDePrimeiroContato(\(i, s, (P_1, \dots, P_i), (T_1, \dots, T_{i - 1}), (S_1, \dots, S_{i - 1})\))} {
	...
	\For {cada aresta \(e\) de \(P_i\)} {
		...
		\(q \leftarrow \text{ConsultaÚltimoPasso}(m, i - 1, s, (P_1, \dots, P_{i - 1}), (T_1, \dots, T_{i - 1}), (S_1, \dots, S_{i - 1}))\) \\
...
O elemento central dessa abordagem é 
