...
Todo o código desenvolvido para esse projeto está disponível no repositório do GitHub: \url{https://github.com/YushiPy/TouringPolygons}, onde também é possível encontrar instruções para executar os algoritmos implementados, assim como acompanhar o desenvolvimento gradual do projeto, servindo como evidência do trabalho realizado.
