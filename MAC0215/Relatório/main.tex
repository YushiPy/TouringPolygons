...
\begin{itemize}
	...
	\item Mês 4: Aproximadamente 80 horas, considerando aproximadamente 70 horas em \textit{commits} e mais 10 horas entre estudo, planejamento, reuniões e preparação para o SIICUSP. Esse mês foi focado na exploração do TPP Irrestrito com polígonos não convexos, desenvolvimento da ferramenta de visualização e otimização da solução para o TPP Irrestrito. 
