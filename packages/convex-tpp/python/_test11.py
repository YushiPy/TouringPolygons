...
ax2.text(*(v2 + Vector2(0.0, 1.2)), "$u^1$", color='black', fontsize=12, ha='center', va='center', backgroundcolor='white', alpha=0.7)
ax2.text(*(v1 + Vector2(0.0, 1.2)), f"$u^{m}$", color='black', fontsize=12, ha='center', va='center', backgroundcolor='white', alpha=0.7)

ax2.arrow(*v1, *(r1 * 0.4), color='blue', width=0.05, head_width=0.3, length_includes_head=True, zorder=5)
ax2.arrow(*v2, *(r2 * 0.4), color='blue', width=0.05, head_width=0.3, length_includes_head=True, zorder=5)

ax2.arrow(*v1, *(v2 - v1), color='blue', width=0.05, head_width=0.3, length_includes_head=True, zorder=5)

ax2.scatter(*v1, color="#67E185", edgecolor='black', linewidth=1.5, s=50, zorder=5)
ax2.scatter(*v2, color="#67E185", edgecolor='black', linewidth=1.5, s=50, zorder=5)
...
ax3.text(*(v + Vector2(0.0, 1.2)), f"$u^1$", color='black', fontsize=12, ha='center', va='center', backgroundcolor='white', alpha=0.7)
ax3.scatter(*v, color="#67E185", edgecolor='black', linewidth=1.5, s=50, zorder=5)

v = sol.filtered[0][-1]
r1, r2 = sol.cones[0][-1]
points = locate_cone(v, r1, r2, bbox)
ax3.fill(*zip(*points), alpha=0.35, edgecolor='red', facecolor='red', linewidth=2.5)
ax3.text(*(v + Vector2(0.0, 1.2)), f"$u^5$", color='black', fontsize=12, ha='center', va='center', backgroundcolor='white', alpha=0.7)
ax3.scatter(*v, color="#67E185", edgecolor='black', linewidth=1.5, s=50, zorder=5)
...
ax4.text(*(v + Vector2(0.0, 1.2)), f"$u^1$", color='black', fontsize=12, ha='center', va='center', backgroundcolor='white', alpha=0.7)
ax4.scatter(*v, color="#67E185", edgecolor='black', linewidth=1.5, s=50, zorder=5)

v = sol.filtered[0][-1]
r = sol.cones[0][-1][1]
points = locate_cone(v, r, r, bbox)
ax4.plot(*zip(*points), alpha=0.35, color='red', linestyle='--', linewidth=3.5)
ax4.text(*(v + Vector2(0.0, 1.2)), f"$u^5$", color='black', fontsize=12, ha='center', va='center', backgroundcolor='white', alpha=0.7)
ax4.scatter(*v, color="#67E185", edgecolor='black', linewidth=1.5, s=50, zorder=5)
...
ax4.text(*(v + Vector2(0.0, 1.2)), f"$u^3$", color='black', fontsize=12, ha='center', va='center', backgroundcolor='white', alpha=0.7)
ax4.scatter(*v, color="#67E185", edgecolor='black', linewidth=1.5, s=50, zorder=5)
...
point = (v1 + v2) * 0.5 + (v2 - v1).perpendicular() * -0.5
ax4.text(*point, "$R^1$", color='black', fontsize=14, ha='center', va='center', backgroundcolor='white', alpha=0.7)
...
point = (v1 + v2) * 0.5 + (v2 - v1).perpendicular() * -0.5
ax4.text(*point, "$R^2$", color='black', fontsize=14, ha='center', va='center', backgroundcolor='white', alpha=0.7)
