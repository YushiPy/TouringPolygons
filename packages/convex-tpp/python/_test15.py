...
def draw(ax: Axes, start: Vector2, target: Vector2, polygon: list[Vector2]) -> None:
	...
	ax.text(start.x + 0.2, start.y + 0.2, 's', color='green', fontsize=16, ha='center', backgroundcolor='white', zorder=4)
	ax.text(target.x + 0.2, target.y + 0.2, 't', color='red', fontsize=16, ha='center', backgroundcolor='white', zorder=4)
