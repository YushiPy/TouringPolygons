...
namespace tpp {
	...
	class Solution {
		...
		DynamicConvexTppWorkspace owned_workspace;
		...
		size_t storage_index(size_t i, size_t j) const;
		bool is_first_contact(size_t i, size_t j) const;
		void set_first_contact(size_t i, size_t j, bool value);
		Cone &cone_slot(size_t i, size_t j);
		...
		*/
		Cone &get_cone(size_t i, size_t j);
		...
		*/
		...
		making it a dynamic programming solution.
		*/
