...
test1.draw([1, 2], False)
#test2.draw([0], False)
#test3.draw([1, 2], False)
#test4.draw([0], False)
#test5.draw([0], False)
#test6.draw([0], False)
#test7.draw([0], False)
