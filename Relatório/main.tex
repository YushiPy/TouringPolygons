...
\begin{wrapfigure}{r}{0.40\textwidth}
	...
	\vspace{-5pt}
	\centering
	\includegraphics[width=0.40\textwidth]{Problem1Images/joined-edge-regions.png}
	\caption{União de regiões de vértice e aresta em uma única região de aresta.}
	\label{problem1-edge-region-union}
