...
\begin{tikzpicture}[remember picture,overlay,shift={(current page.north west)},x=1cm,y=-1cm]
  ...
  \block{event}{13}{2.0}{57.5}{\tagtext 34º SIICUSP\hspace{0.55cm}/\hspace{0.55cm}INSTITUTO DE MATEMÁTICA E ESTATÍSTICA\hspace{0.35cm}·\hspace{0.35cm}USP}
  \block{event-logo}{72.1}{1.9}{10.7}{\includegraphics[width=\linewidth]{../resumo/assets/siicusp34-logo-pt.png}}
  \block{funding-logo}{72.1}{12.75}{10.7}{\includegraphics[width=\linewidth]{figures/fapesp-logo.png}}
  \block{funding}{72.1}{15.2}{10.7}{\sffamily\fontsize{17}{21}\selectfont\color{Muted}Processo 2025/13861-1}
  ...
  \block{author}{3}{14.1}{37}{\sffamily\bfseries\fontsize{48}{55}\selectfont\color{Ink}Gabriel Freire Ushijima\par\vspace{0.08cm}\mdseries\fontsize{23}{27}\selectfont\color{Muted}\href{mailto:gabriel_ushijima@usp.br}{gabriel\_ushijima@usp.br}}
  \block{advisor}{42}{14.1}{39.1}{\sffamily\fontsize{38}{50}\selectfont\color{Ink}Orientador: \textbf{Ernesto G. Birgin}\par\vspace{0.08cm}\fontsize{23}{27}\selectfont\color{Muted}\href{mailto:egbirgin@ime.usp.br}{egbirgin@ime.usp.br}}
  ...
  \block{usp-map}{3}{43.8}{50.8}{\includegraphics[width=\linewidth]{figures/usp-route-print.png}}
  ...
  % The dark margin holds the formal search-space counts for this USP instance.
  \fill[MapDark,opacity=0.97] (4.1,61.8) rectangle (15.2,70.5);
  \draw[Rule,line width=0.8pt] (4.1,61.8) rectangle (15.2,70.5);
  \draw[Accent,line width=2pt] (4.1,61.8) -- (7.4,61.8);
  \block{map-combinations}{4.55}{62.15}{10.4}{\sffamily\bfseries\fontsize{18}{22}\selectfont\color{white}ESPAÇO FORMAL\par\vspace{0.06cm}\sffamily\mdseries\fontsize{19}{24}\selectfont $51!\approx1{,}55\times10^{66}$ ordens\par $\prod_i p_i\approx2{,}49\times10^{37}$\par\sffamily\fontsize{17}{20}\selectfont escolhas de peças convexas\par\vspace{0.08cm}\sffamily\bfseries\fontsize{28}{32}\selectfont\color{Route}$3{,}87\times10^{103}$\par\sffamily\fontsize{17}{21}\selectfont\color{white}combinações formais\par\vspace{0.05cm}\sffamily\fontsize{20}{24}\selectfont Resolvido em \textbf{8,77 s}\par\sffamily\fontsize{15}{18}\selectfont\color{white}Ótimo numérico; uma thread.\par O solver não enumerou esse espaço.}
  ...
  \block{map-caption}{3}{75.7}{50.8}{\smalltext Contornos desenhados pelo autor no QGIS sobre mapa-base público (OpenStreetMap). Incluem IF, IO, FAU, Geociências, Química, FFLCH, IP, ECA, FEA, Poli, Biblioteca Brasiliana, Restaurante Central, Praça dos Bancos e Google.\par\textbf{Demonstração independente do corpus experimental.} Regiões são alvos, não obstáculos; regras de voo não são modeladas.}
  ...
  \block{branch-and-bound}{56.1}{59.1}{25}{\bodytext Cada nó guarda uma ordem parcial, por exemplo $s\to\mathrm{IF}\to\mathrm{Central}\to t$. Omitir regiões e usar fechos convexos relaxa o problema.}
  % A valid relaxation supplies L; a complete feasible path supplies U.
  \fill[Pale] (56.1,64.5) rectangle (68.4,67.5);
  \draw[Rule,line width=0.8pt] (56.1,64.5) rectangle (68.4,67.5);
  \fill[Accent!7] (68.9,64.5) rectangle (81.1,67.5);
  \draw[Rule,line width=0.8pt] (68.9,64.5) rectangle (81.1,67.5);
  \block{lower-bound}{56.5}{64.9}{11.5}{\tagtext LIMITE INFERIOR\par\smalltext relaxação $L$}
  \block{upper-bound}{69.3}{64.9}{11.4}{\tagtext ROTA VIÁVEL\par\smalltext incumbente $U$}
  \draw[Muted,line width=1.4pt,-{Stealth[length=3.5mm]}] (62.25,67.5) -- (62.25,68.2) -- (67.8,68.2) -- (67.8,68.8);
  \draw[Muted,line width=1.4pt,-{Stealth[length=3.5mm]}] (75.0,67.5) -- (75.0,68.2) -- (67.8,68.2);
  \fill[Pale] (56.1,68.8) rectangle (81.1,70.7);
  \block{prune}{56.1}{69.0}{25}{\centering\sffamily\bfseries\fontsize{39}{47}\selectfont\color{Accent}$L\geq U-\varepsilon\ \Rightarrow\ \text{poda}$}
  \block{branch-label}{56.1}{71.3}{25}{\tagtext Se não puder podar, ramifique:}
  \fill[Pale] (56.1,72.3) rectangle (68.4,76.1);
  \draw[Rule,line width=0.8pt] (56.1,72.3) rectangle (68.4,76.1);
  \fill[Pale] (68.9,72.3) rectangle (81.1,76.1);
  \draw[Rule,line width=0.8pt] (68.9,72.3) rectangle (81.1,76.1);
  \block{insert-branch}{56.5}{72.6}{11.5}{\tagtext INSERIR\par\smalltext região em cada posição}
  \block{refine-branch}{69.3}{72.6}{11.4}{\tagtext REFINAR\par\smalltext fecho em peças convexas}
  \block{method-note}{56.1}{76.6}{25}{\smalltext Inserção e refinamento adaptados de [3]. IF $\to$ Central $\to$ IAG ilustra um desvio; só um limite válido justifica a poda.}
  ...
  \fill[Pale] (3,98.7) rectangle (81.1,101.0);
  \block{conclusion-label}{3.6}{99.2}{10.4}{\tagtext CONCLUSÃO}
  \block{conclusion}{15}{98.9}{66.1}{\sffamily\mdseries\fontsize{21}{25}\selectfont\color{Muted}Na campanha medida, limites fecharam e visitas foram validadas a $10^{-7}$ nas unidades dos dados em \textbf{558/558} casos; isso não garante generalização. Fekete: \textbf{130/551} trajetórias disponíveis passaram na mesma tolerância geométrica.}
