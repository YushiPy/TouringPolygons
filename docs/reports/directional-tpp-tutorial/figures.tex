...
\begin{scope}
  ...
  \draw[coordgrid] (-2,0) grid[step=.5] (2,2);
  ...
  \node[smalllabel,above left] at (-2,1) {\(s=(-2,1)\)};
  \node[smalllabel,below left] at (-1,0) {\(q=(-1,0)\)};
  \node[smalllabel,above right] at (0,1/3) {\(c=(0,1/3)\)};
  \node[smalllabel,above right] at (1.65,1.72) {\(P=[0,2]\times[0,2]\)};
  \node[font=\scriptsize\bfseries,color=navy] at (1,-.58)
    {(a) physical route};
\end{scope}
\begin{scope}[xshift=6cm]
  ...
  \node[smalllabel,below left] at (-1,0) {\(q\)};
  \node[smalllabel,above right] at (0,1/3) {\(c\)};
  \node[smalllabel,below right] at (1,0) {\(q'=(1,0)\)};
  \node[smalllabel,above right] at (.4,1.72) {\(q'=R_{x=0}(q)\)};
  \node[font=\scriptsize\bfseries,color=navy] at (1,-.58)
    {(b) unfolded segment};
\end{scope}
\end{tikzpicture}}
...
\begin{scope}
\draw[polyA] (0,0) rectangle (2,2);
\draw[coordgrid] (-2,0) grid[step=.5] (3,2);
\draw[route,-Latex] (-2,1)--(3,1);
...
\node[smalllabel,align=center] at (1,-.68)
  {\(s=(-2,1),\ q=(1,1)\in P\);\\\(F_0(q)=F_1(q)=F_2(q)=F_3(q)=3\)};
\end{scope}
\end{tikzpicture}}
...
\begin{scope}[xshift=10.5cm]
  ...
  \node[smalllabel,above left,align=right] at (0,3) {\((0,3)\)\\\(P_1,P_3\)};
  \node[smalllabel,above right,align=left] at (4/7,2) {\((4/7,2)\)\\\(P_2\) later};
...
\begin{scope}[xshift=21cm]
  ...
  \node[smalllabel,below right] at (0,2) {\((0,2):\ 1=2\)};
  \node[smalllabel,above right] at (.5,3) {\((1/2,3):\ 3\)};
  \node[smalllabel,align=center] at (0,-5.35)
